...
/** 返回结果«维保单位、企业单位、高地大化重点单位关联表(南宁维保模块)» */
export interface _7 {
  /** 代码 */
  code?: string;
  /** 数据 */
...
/** 返回结果«附件信息表(srvc_file_enclosure)» */
export interface SrvcFileEnclosure {
  /** 代码 */
  code?: string;
  /** 数据 */
  data?: SrvcFileEnclosure2;
  /** 提示消息 */
  msg?: object;
}

/** 附件信息表(srvc_file_enclosure) */
export interface SrvcFileEnclosure2 {
  cjryhzh: string;
  /** @format date-time */
  cjsj?: string;
  /**
...
export interface KeyUsingGetParams {
  /** 主键 */
  id: string;
}

export interface GetWbfxInfoUsingGetParams {
  /** zddwid */
  zddwid?: string;
}
...
export interface GetFileEnclosuresByGlidUsingGetParams {
  /** glid */
  glid: string;
}
