 ...
 * @LastEditTime: 2025-11-10 16:47:53
 * @LastEditors: huanghuanrong
 * @Description: 文件描述
 * @FilePath: \app\alova.config.ts
 */
  ...
  generator: [
    {
       ...
       * 2. local file
       */
      input: 'http://192.168.173.153:9710/v2/api-docs',
      /**
      ...
      handleApi: (apiDescriptor) => {
        ...
        // apiDescriptor.headers = apiDescriptor.headers || {}
        // apiDescriptor.headers.Authorization = `${uni.getStorageSync('Token') || ''}`
